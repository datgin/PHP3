                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" onkeyup="ChangeToSlug()" name="title" id="title"
                                                class="form-control slug" placeholder="Title">
                                            <p id="error"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="slug" readonly id="slug"
                                                class="form-control convert_slug" placeholder="Slug">
                                            <p id="error"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#productForm').submit(function(e) {
                e.preventDefault();
                let element = new FormData(this); // Tạo một FormData mới để gửi dữ liệu

                // Thêm ảnh hiện tại
                if ($('#image').val()) {
                    element.append('image', $('#image')[0].files[0]);
                }

                // Thêm các file ảnh đã chọn vào FormData
                for (let i = 0; i < galleryImages.length; i++) {
                    element.append('gallery_images[]', galleryImages[i]);
                }
