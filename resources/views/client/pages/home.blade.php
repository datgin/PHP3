        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel"
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('client-assets/images/carousel-1-m.jpg') }}" />
                        <source media="(min-width: 800px)" srcset="{{ asset('client-assets/images/carousel-1.jpg') }}" />
                        <img src="{{ asset('client-assets/images/carousel-1.jpg') }}" alt="" />
                    </picture>
                ...
                <div class="carousel-item">
                    ...
                    <picture>
                        ...
                        <source media="(min-width: 800px)" srcset="{{ asset('client-assets/images/carousel-2.jpg') }}" />
                        <img src="{{ asset('client-assets/images/carousel-2.jpg') }}" alt="" />
                    </picture>
                ...
                <div class="carousel-item">
                    <!-- <img src="{{ asset('client-assets/images/carousel-3.jpg') }}" class="d-block w-100" alt=""> -->

                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('client-assets/images/carousel-3-m.jpg') }}" />
                        <source media="(min-width: 800px)" srcset="{{ asset('client-assets/images/carousel-3.jpg') }}" />
                        <img src="{{ asset('client-assets/images/carousel-2.jpg') }}" alt="" />
                    </picture>
